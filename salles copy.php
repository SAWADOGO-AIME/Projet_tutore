            ...
            <div class="resultat_recherche">
                ...
                if (isset($_GET['barre_rechercher_salle'])) {
                    foreach ($tableaufetch as $colonne) {
                        echo '<div class="resultat_individuel">';
                        echo '<h3>';
                        echo htmlspecialchars($row['nom_salle']);
                        echo '</h3>';
                        echo 'Site : <span>' . htmlspecialchars($row['emplacement']) . '</span> <br>';
                        echo 'Etat : <span>' . htmlspecialchars($row['salle_disponible']) . '</span> <br>';
                        echo '<p>';
                        echo 'Nombre de places : <span>' . htmlspecialchars($row['nombre_places']) . '</span> <br>';
                        echo '<div id="bouton">';
                        echo '<a href="#"><button>Réserver</button></a>';
                        echo '</div>';
                        echo '</p>';
